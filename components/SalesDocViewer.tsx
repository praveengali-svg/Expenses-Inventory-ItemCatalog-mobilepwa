                    ...
                    <div className="space-y-4">
                       <div>
                          ...
                          <div className="text-[9px] font-medium text-slate-600 leading-tight bg-slate-50 p-4 rounded-2xl border border-slate-100 border-l-2 border-l-[#E67E22] shadow-sm">
                             ...
                             <p className="mb-0.5"><span className="text-slate-400 uppercase text-[7px] font-black inline-block w-16">Bank:</span> HDFC Bank</p>
                             <p className="mb-0.5"><span className="text-slate-400 uppercase text-[7px] font-black inline-block w-16">A/C No:</span> 50200086884351</p>
                             <p className="mb-0.5"><span className="text-slate-400 uppercase text-[7px] font-black inline-block w-16">IFSC:</span> HDFC0000041</p>
                             <p><span className="text-slate-400 uppercase text-[7px] font-black inline-block w-16">Branch:</span> Richmond Road, Bangalore</p>
